...
class CfgWorlds
{
 ...
 class GOL_Massive: Stratis
 {
  cutscenes[] = {};
  author = "-{GOL}-Jason";
  description = "Massive";
  pictureMap = "GOL_Massive\data\pictureMap_ca.paa"; 
  worldName = "GOL_Massive\GOL_Massive.wrp";
  startTime = "11:00";
  ...
  newRoadsShape = "GOL_Massive\data\roads\roads.shp";
