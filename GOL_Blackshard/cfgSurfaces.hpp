...
{
	class Default {};
	class GOL_Blackshard_Snow_Surface : Default
	{	
		 files = "GOL_Blackshard_Snow_*";
		 rough = 0.8;
		 maxSpeedCoef = 0.3;
		 dust = 0.1;
		 soundEnviron = "sand";
		 //character = "GOL_Blackshard_Snow_Character";
		 character = "Empty";
	...
	class GOL_Blackshard_Stony_Surface : Default
	{	
		 files = "GOL_Blackshard_Stony_*";
		 rough = 0.9;
		 maxSpeedCoef = 0.5;
		 dust = 0.1;
		 soundEnviron = "rock";
	...
	class GOL_Blackshard_Beach_Surface : Default
	{	
		 files = "GOL_Blackshard_Beach_*";
		 rough = 0.4;
		 maxSpeedCoef = 0.8;
		 dust = 0.5;
		 soundEnviron = "sand";
		 //character = "GOL_Blackshard_Beach_Character";
		 character = "Empty";
		 soundHit = "soft_ground";
		 lucidity = 1;
		 grassCover = 0.1;
	};
	class GOL_Blackshard_Lowland_Surface : Default
	{	
		 files = "GOL_Blackshard_Lowland_*";
		 rough = 0.4;
		 maxSpeedCoef = 0.6;
		 dust = 0.4;
		 soundEnviron = "seabed_exp";
		 //character = "GOL_Blackshard_Lowland_Character";
		 character = "Empty";
		 soundHit = "soft_ground";
		 lucidity = 1;
		 grassCover = 0.1;
	};
	class GOL_Blackshard_Highlandland_Surface : Default
	{	
		 files = "GOL_Blackshard_Highlandland_*";
		 rough = 0.4;
		 maxSpeedCoef = 0.6;
		 dust = 0.4;
		 soundEnviron = "seabed_exp";
		 //character = "GOL_Blackshard_Highlandland_Character";
		 character = "Empty";
		 soundHit = "soft_ground";
		 lucidity = 1;
		 grassCover = 0.1;
